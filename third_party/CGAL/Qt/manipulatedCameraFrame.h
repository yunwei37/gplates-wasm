...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/manipulatedCameraFrame.h $
// $Id: manipulatedCameraFrame.h 1969ee9 %aI Andreas Fabri
// SPDX-License-Identifier: GPL-3.0

#ifndef QOpenGLVIEWER_MANIPULATED_CAMERA_FRAME_H
#define QOpenGLVIEWER_MANIPULATED_CAMERA_FRAME_H
#include <QTimer>
...
/*! \brief The ManipulatedCameraFrame class represents a ManipulatedFrame with
  ...
  manipulatedCameraFrame.h CGAL::QOpenGLViewer/manipulatedCameraFrame.h
...
public Q_SLOTS:
  ...
  CGAL::QOpenGLViewer::sceneRadius() when the ManipulatedCameraFrame is set as the
  Camera::frame(). */
...
public:
  ...
  value is set according to the CGAL::QOpenGLViewer::sceneRadius() by
  CGAL::QOpenGLViewer::setSceneRadius(). */
...
#endif // QOpenGLVIEWER_MANIPULATED_CAMERA_FRAME_H
