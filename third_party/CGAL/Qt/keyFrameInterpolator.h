...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/keyFrameInterpolator.h $
// $Id: keyFrameInterpolator.h 1969ee9 %aI Andreas Fabri
// SPDX-License-Identifier: GPL-3.0
#ifndef QOpenGLVIEWER_KEY_FRAME_INTERPOLATOR_H
#define QOpenGLVIEWER_KEY_FRAME_INTERPOLATOR_H
...
/*! \brief A keyFrame Catmull-Rom Frame interpolator.
  ...
  CGAL::QOpenGLViewer/keyFrameInterpolator.h
  ...
  signal, which will usually be connected to the CGAL::QOpenGLViewer::update() slot. The
  ...
  Fx plays/pauses path interpolation. See CGAL::QOpenGLViewer::pathKey() and the <a
  ...
  the CGAL::QOpenGLViewer::update() slot before calling this code. \nosubgrouping */
...
Q_SIGNALS:
  ...
  This signal should especially be connected to your CGAL::QOpenGLViewer::update() slot,
  ...
  SLOT(update())); \endcode Use the CGAL::QOpenGLViewer::QOpenGLViewerPool() to connect the
  signal to all the viewers.

  Note that the CGAL::QOpenGLViewer::camera() Camera::keyFrameInterpolator() created using
  CGAL::QOpenGLViewer::pathKey() have their interpolated() signals automatically connected
  to the CGAL::QOpenGLViewer::update() slot. */
  void interpolated();
...
#endif // QOpenGLVIEWER_KEY_FRAME_INTERPOLATOR_H
