...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/constraint.h $
// $Id: constraint.h 1969ee9 %aI Andreas Fabri
// SPDX-License-Identifier: GPL-3.0
#ifndef QOpenGLVIEWER_CONSTRAINT_H
#define QOpenGLVIEWER_CONSTRAINT_H
...
/*! \brief An interface class for Frame constraints.
  \class Constraint constraint.h CGAL::QOpenGLViewer/constraint.h
...
/*!
   ...
   \class AxisPlaneConstraint constraint.h CGAL::QOpenGLViewer/constraint.h
   ...
   CGAL::QOpenGLViewer::camera(), so that we can compute the projected coordinates of the
   rotation center (as is done with the CGAL::QOpenGLViewer::SCREEN_ROTATE binding).
   However, adding an extra pointer to the CGAL::QOpenGLViewer::camera() in all the
...
/*! \brief An AxisPlaneConstraint defined in the Frame local coordinate system.
  \class LocalConstraint constraint.h CGAL::QOpenGLViewer/constraint.h
...
/*! \brief An AxisPlaneConstraint defined in the world coordinate system.
        \class WorldConstraint constraint.h CGAL::QOpenGLViewer/constraint.h
...
/*! \brief An AxisPlaneConstraint defined in the camera coordinate system.
  \class CameraConstraint constraint.h CGAL::QOpenGLViewer/constraint.h
...
#endif // QOpenGLVIEWER_CONSTRAINT_H
