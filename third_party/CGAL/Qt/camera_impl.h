...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/camera_impl.h $
// $Id: camera_impl.h 93d9e8e %aI Jane
...
/*! Equal operator.
 ...
 camera. If your Camera is associated with a CGAL::QOpenGLViewer, you should update these
...
You should not call this method when the Camera is associated with a CGAL::QOpenGLViewer,
...
If your Camera is used without a CGAL::QOpenGLViewer (offscreen rendering, shadow maps),
...
/*! Returns the near clipping plane distance used by the Camera projection
 ...
 CGAL::QOpenGLViewer::setCamera(): \code class myCamera :: public CGAL::qglviewer::Camera
 {
...
/*! Computes the projection matrix associated with the Camera.
 ...
 CGAL::QOpenGLViewer and is used for offscreen computations (using
...
/*! Loads the OpenGL \c GL_PROJECTION matrix with the Camera projection matrix.
 ...
 a picking matrix. See CGAL::QOpenGLViewer::beginSelection() for details.

 This method is used by CGAL::QOpenGLViewer::preDraw() (called before user's
 CGAL::QOpenGLViewer::draw() method) to set the \c GL_PROJECTION matrix according to the
 viewer's CGAL::QOpenGLViewer::camera() settings.
...
/*! Loads the OpenGL \c GL_MODELVIEW matrix with the modelView matrix
 ...
 This method is used by CGAL::QOpenGLViewer::preDraw() (called before user's
 CGAL::QOpenGLViewer::draw() method) to set the \c GL_MODELVIEW matrix according to the
 viewer's CGAL::QOpenGLViewer::camera() position() and orientation().

 As a result, the vertices used in CGAL::QOpenGLViewer::draw() can be defined in the so
 ...
 CGAL::QOpenGLViewer::draw() if you want your Camera to use an exotic modelView matrix.
...
/*! Fills \p m with the Camera projection matrix values.
 ...
 \c GL_PROJECTION after CGAL::QOpenGLViewer::preDraw(), at the beginning of
 CGAL::QOpenGLViewer::draw(). If you modified the \c GL_PROJECTION matrix (for instance
 using CGAL::QOpenGLViewer::startScreenCoordinatesSystem()), the two results differ.
...
/*! Fills \p m with the Camera modelView matrix values.
 ...
 \c GL_MODELVIEW after CGAL::QOpenGLViewer::preDraw(), at the \e beginning of
 CGAL::QOpenGLViewer::draw(). It converts from the world to the Camera coordinate system.
 As soon as you modify the \c GL_MODELVIEW in your CGAL::QOpenGLViewer::draw() method
...
/*! Changes the Camera fieldOfView() so that the entire scene (defined by
 CGAL::QOpenGLViewer::sceneCenter() and CGAL::QOpenGLViewer::sceneRadius()) is visible from the
 Camera position().
...
/*! Moves the Camera so that the entire scene is visible.
 ...
 You will typically use this method in CGAL::QOpenGLViewer::init() after you defined a new
 sceneRadius(). */
CGAL_INLINE_FUNCTION
...
/*! Rotates the Camera so that its upVector() becomes \p up (defined in the
 ...
 (see the CGAL::QOpenGLViewer::MOVE_FORWARD and CGAL::QOpenGLViewer::MOVE_BACKWARD
 CGAL::QOpenGLViewer::MouseAction).
...
/*! Sets the orientation() of the Camera using polar coordinates.
 ...
 CGAL::QOpenGLViewer::saveSnapshot() documentation for details. */
CGAL_INLINE_FUNCTION
...
CGAL::QOpenGLViewer::MOVE_FORWARD or CGAL::QOpenGLViewer::MOVE_BACKWARD.
...
/*! The point the Camera pivots around with the CGAL::QOpenGLViewer::ROTATE mouse binding.
...
/*! Returns the screen projected coordinates of a point \p src defined in the \p frame coordinate
 ...
 \attention However, if your Camera is not attached to a CGAL::QOpenGLViewer (used for offscreen computations
...
/*! Sets the KeyFrameInterpolator that defines the Camera path of index \p i.
 ...
 connected to the Camera's associated CGAL::QOpenGLViewer::update() slot, so that when the
 ...
 CGAL::QOpenGLViewer, or when a new KeyFrameInterpolator is defined using the
 CGAL::QOpenGLViewer::addKeyFrameKeyboardModifiers() and CGAL::QOpenGLViewer::pathKey() (default is
...
CGAL::QOpenGLViewer::pathKey() and CGAL::QOpenGLViewer::addKeyFrameKeyboardModifiers().
...
then be connected to the CGAL::QOpenGLViewer::update() slot (see
...
/*! Makes the Camera follow the path of keyFrameInterpolator() number \p i.
 ...
 CGAL::QOpenGLViewer::pathKey() and CGAL::QOpenGLViewer::playPathKeyboardModifiers(). */
CGAL_INLINE_FUNCTION
...
/*! Returns an XML \c QDomElement that represents the Camera.
 ...
 Note that the CGAL::QOpenGLViewer::camera() is automatically saved by
 CGAL::QOpenGLViewer::saveStateToFile() when a CGAL::QOpenGLViewer is closed. Use
 CGAL::QOpenGLViewer::restoreStateFromFile() to restore it back. */
CGAL_INLINE_FUNCTION
