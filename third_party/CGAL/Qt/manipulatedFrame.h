...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/manipulatedFrame.h $
// $Id: manipulatedFrame.h 1969ee9 %aI Andreas Fabri
// SPDX-License-Identifier: GPL-3.0

#ifndef QOpenGLVIEWER_MANIPULATED_FRAME_H
#define QOpenGLVIEWER_MANIPULATED_FRAME_H
...
/*! \brief A ManipulatedFrame is a Frame that can be rotated and translated
  ...
  CGAL::QOpenGLViewer/manipulatedFrame.h
  ...
  A ManipulatedFrame is attached to a CGAL::QOpenGLViewer using
  CGAL::QOpenGLViewer::setManipulatedFrame(): \code init() { setManipulatedFrame( new
  ManipulatedFrame() ); }
  ...
  Mouse events are normally sent to the CGAL::QOpenGLViewer::camera(). You have to press
  the CGAL::QOpenGLViewer::FRAME state key (default is \c Control) to move the
  CGAL::QOpenGLViewer::manipulatedFrame() instead. See the <a href="../mouse.html">mouse
  ...
  ManipulatedFrame becomes the new CGAL::QOpenGLViewer::mouseGrabber(). It can then be
  ...
  A CGAL::QOpenGLViewer can handle at most one ManipulatedFrame at a time. If you want to
  ...
  CGAL::QOpenGLViewer::setManipulatedFrame()) when needed. This can for instance be done
  ...
  trigger a specific action or display (as is done with CGAL::QOpenGLViewer::fastDraw()).
  ...
  CGAL::QOpenGLViewer::update() slot when the ManipulatedFrame is attached to a viewer
  using CGAL::QOpenGLViewer::setManipulatedFrame().
...
#ifndef DOXYGEN
  friend class Camera;
  friend class ::CGAL::QOpenGLViewer;
#endif
...
Q_SIGNALS:
  ...
  Note that this signal is automatically connected to the CGAL::QOpenGLViewer::update()
  slot, when the ManipulatedFrame is attached to a viewer using
  CGAL::QOpenGLViewer::setManipulatedFrame(), which is probably all you need.

  Use the CGAL::QOpenGLViewer::QOpenGLViewerPool() if you need to connect this signal to all
  the viewers.
  ...
  Note that for the CGAL::QOpenGLViewer::manipulatedFrame(), this signal is automatically
  connected to the CGAL::QOpenGLViewer::update() slot.

  Connect this signal to any object that should be notified. Use the
  CGAL::QOpenGLViewer::QOpenGLViewerPool() if you need to connect this signal to all the
  viewers.
...
public:
  ...
  (see the CGAL::QOpenGLViewer::RAP_FROM_PIXEL mouse binding in the <a
...
public:
  ...
  /*! Returns the \c MouseAction currently applied to this ManipulatedFrame.
    ...
    Will return CGAL::QOpenGLViewer::NO_MOUSE_ACTION unless a mouse button is being
   pressed and has been bound to this CGAL::QOpenGLViewer::MouseHandler.

   The binding between mouse buttons and key modifiers and MouseAction is set
   using CGAL::QOpenGLViewer::setMouseBinding(Qt::Key key, Qt::KeyboardModifiers
...
#endif // QOpenGLVIEWER_MANIPULATED_FRAME_H
