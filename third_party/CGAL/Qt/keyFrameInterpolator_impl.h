...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/keyFrameInterpolator_impl.h $
...
/*! Starts the interpolation process.
  ...
  You may also be interested in CGAL::QOpenGLViewer::animate() and
  CGAL::QOpenGLViewer::startAnimation().
...
/*! Returns an XML \c QDomElement that represents the KeyFrameInterpolator.
 ...
 CGAL::QOpenGLViewer::saveStateToFile() when a CGAL::QOpenGLViewer is closed. */
CGAL_INLINE_FUNCTION
