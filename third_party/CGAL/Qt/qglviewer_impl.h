/****************************************************************************
 ...
 This file is part of a fork of the QOpenGLViewer library version 2.7.0.
...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/qglviewer_impl.h $
...
QList<CGAL::QOpenGLViewer *> &CGAL::QOpenGLViewer::QOpenGLViewerPool() {
  static QList<CGAL::QOpenGLViewer *> QOpenGLViewerPool_;
  void* p = qApp->property("qglviewer pool").value<void*>();
  if(p == 0) {
    p = (void*)(&QOpenGLViewerPool_);
    qApp->setProperty("qglviewer pool", QVariant::fromValue(p));
  }
  return *static_cast<QList<CGAL::QOpenGLViewer *> * >(p);
}

/*! \mainpage

libCGAL::QOpenGLViewer is a free C++ library based on Qt that enables the quick creation
...
libCGAL::QOpenGLViewer is <i>not</i> a 3D viewer that can be used directly to view 3D
scenes in various formats. It is more likely to be the starting point for the
coding of such a viewer.

libCGAL::QOpenGLViewer is based on the Qt toolkit and hence compiles on any architecture
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::defaultConstructor() {
  
  int poolIndex = CGAL::QOpenGLViewer::QOpenGLViewerPool().indexOf(NULL);
  setFocusPolicy(::Qt::StrongFocus);

  if (poolIndex >= 0)
    CGAL::QOpenGLViewer::QOpenGLViewerPool().replace(poolIndex, this);
  else
    CGAL::QOpenGLViewer::QOpenGLViewerPool().append(this);
...
CGAL_INLINE_FUNCTION
CGAL::QOpenGLViewer::QOpenGLViewer(QWidget *parent,
...
The viewer is replaced by \c NULL in the QOpenGLViewerPool() (in order to preserve
...
CGAL_INLINE_FUNCTION
CGAL::QOpenGLViewer::~QOpenGLViewer() {
  ...
  CGAL::QOpenGLViewer::QOpenGLViewerPool().replace(CGAL::QOpenGLViewer::QOpenGLViewerPool().indexOf(this),
                                    NULL);
...
/*! Initializes the CGAL::QOpenGLViewer OpenGL context and then calls user-defined init().
...
*/
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::initializeGL() {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::paintGL() {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::preDraw() {
  glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
...
method. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::postDraw() {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::fastDraw() { draw(); }
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setCameraIsEdited(bool edit) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setDefaultShortcuts() {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setDefaultMouseBindings() {
...
removed. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setCamera(qglviewer::Camera *const camera) {
  if (!camera)
    return;
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::connectAllCameraKFIInterpolatedSignals(bool connection) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::drawLight(GLenum, qreal ) const {
}

#if (QT_VERSION >= QT_VERSION_CHECK(5, 4, 0))
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::renderText(int x, int y, const QString &str,
                           const QFont &font) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::renderText(double x, double y, double z, const QString &str,
                           const QFont &font) {
...
*/
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::drawText(int x, int y, const QString &text, const QFont &fnt) {
  if (!textIsEnabled())
    return;
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::displayMessage(const QString &message, int delay) {
  message_ = message;
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::hideMessage() {
  displayMessage_ = false;
  if (textIsEnabled())
    update();
}
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::displayFPS() {
  drawText(10,
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::startScreenCoordinatesSystem(bool ) const {
}
...
GL_MODELVIEW. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::stopScreenCoordinatesSystem() const {
}
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::timerEvent(QTimerEvent *) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::startAnimation() {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::stopAnimation() {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::closeEvent(QCloseEvent *e) {
...
mechanism and you did not overload CGAL::QOpenGLViewer. If you choose to derive your own
...
This method is called when you use the CGAL::QOpenGLViewer::SELECT mouse binding(s)
(default is Shift + left button). Use setMouseBinding() to change this. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::select(const QMouseEvent *event) {
...
It is called when the user clicks on the CGAL::QOpenGLViewer::SELECT
CGAL::QOpenGLViewer::ClickAction binded button(s) (default is Shift + LeftButton).
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::select(const QPoint &point) {
  beginSelection(point);
  drawWithNames();
  endSelection(point);
  postSelection(point);
...
*/
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::beginSelection(const QPoint &point) 
{
  makeCurrent();
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::endSelection(const QPoint &point) {
  Q_UNUSED(point);
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setSelectBufferSize(int size) {
  if (selectBuffer_)
    delete[] selectBuffer_;
...
static QString mouseButtonsString(::Qt::MouseButtons b) {
  ...
  if (b & ::Qt::LeftButton) {
    result += CGAL::QOpenGLViewer::tr("Left", "left mouse button");
    addAmpersand = true;
  }
  if (b & ::Qt::MidButton) {
    if (addAmpersand)
      result += " & ";
    result += CGAL::QOpenGLViewer::tr("Middle", "middle mouse button");
    addAmpersand = true;
  }
  if (b & ::Qt::RightButton) {
    if (addAmpersand)
      result += " & ";
    result += CGAL::QOpenGLViewer::tr("Right", "right mouse button");
  }
  return result;
}

CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::performClickAction(qglviewer::ClickAction ca, const QMouseEvent *const e) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::mousePressEvent(QMouseEvent *e) {
...
if ((e->button() == myButton) && (e->modifiers() == myModifiers))
  ...
  CGAL::QOpenGLViewer::mousePressEvent(e);
}
...
if (myMouseBehavior)
  ...
  CGAL::QOpenGLViewer::mouseMoveEvent(e);
}
...
if (myMouseBehavior)
  ...
  CGAL::QOpenGLViewer::mouseReleaseEvent(e);
}
\endcode */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::mouseMoveEvent(QMouseEvent *e) {
  if (mouseGrabber()) {
...
customization. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::mouseReleaseEvent(QMouseEvent *e) {
  if (mouseGrabber()) {
    if (mouseGrabberIsAManipulatedCameraFrame_)
      (dynamic_cast<qglviewer::ManipulatedFrame *>(mouseGrabber()))
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::wheelEvent(QWheelEvent *e) {
  if (mouseGrabber()) {
    if (mouseGrabberIsAManipulatedFrame_) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::mouseDoubleClickEvent(QMouseEvent *e) {
  //#CONNECTION# mousePressEvent has the same structure
...
If the CGAL::QOpenGLViewer is embedded in an other QWidget (see
CGAL_INLINE_FUNCTION
QWidget::topLevelWidget()), this widget is displayed in full screen instead. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setFullScreen(bool fullScreen) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setMouseGrabber(qglviewer::MouseGrabber *mouseGrabber) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setMouseGrabberIsEnabled(
...
CGAL_INLINE_FUNCTION
QString CGAL::QOpenGLViewer::mouseActionString(qglviewer::MouseAction ma) {
  switch (ma) {
  case CGAL::qglviewer::NO_MOUSE_ACTION:
    return QString::null;
  case CGAL::qglviewer::ROTATE:
    return CGAL::QOpenGLViewer::tr("Rotates", "ROTATE mouse action");
  case CGAL::qglviewer::ZOOM:
    return CGAL::QOpenGLViewer::tr("Zooms", "ZOOM mouse action");
  case CGAL::qglviewer::TRANSLATE:
    return CGAL::QOpenGLViewer::tr("Translates", "TRANSLATE mouse action");
  case CGAL::qglviewer::MOVE_FORWARD:
    return CGAL::QOpenGLViewer::tr("Moves forward", "MOVE_FORWARD mouse action");
  case CGAL::qglviewer::LOOK_AROUND:
    return CGAL::QOpenGLViewer::tr("Looks around", "LOOK_AROUND mouse action");
  case CGAL::qglviewer::MOVE_BACKWARD:
    return CGAL::QOpenGLViewer::tr("Moves backward", "MOVE_BACKWARD mouse action");
  case CGAL::qglviewer::SCREEN_ROTATE:
    return CGAL::QOpenGLViewer::tr("Rotates in screen plane",
                         "SCREEN_ROTATE mouse action");
  case CGAL::qglviewer::ROLL:
    return CGAL::QOpenGLViewer::tr("Rolls", "ROLL mouse action");
  case CGAL::qglviewer::DRIVE:
    return CGAL::QOpenGLViewer::tr("Drives", "DRIVE mouse action");
  case CGAL::qglviewer::SCREEN_TRANSLATE:
    return CGAL::QOpenGLViewer::tr("Horizontally/Vertically translates",
                         "SCREEN_TRANSLATE mouse action");
  case CGAL::qglviewer::ZOOM_ON_REGION:
    return CGAL::QOpenGLViewer::tr("Zooms on region for", "ZOOM_ON_REGION mouse action");
  }
  return QString::null;
}

CGAL_INLINE_FUNCTION
QString CGAL::QOpenGLViewer::clickActionString(CGAL::qglviewer::ClickAction ca) {
  switch (ca) {
  case CGAL::qglviewer::NO_CLICK_ACTION:
    return QString::null;
  case CGAL::qglviewer::ZOOM_ON_PIXEL:
    return CGAL::QOpenGLViewer::tr("Zooms on pixel", "ZOOM_ON_PIXEL click action");
  case CGAL::qglviewer::ZOOM_TO_FIT:
    return CGAL::QOpenGLViewer::tr("Zooms to fit scene", "ZOOM_TO_FIT click action");
  case CGAL::qglviewer::SELECT:
    return CGAL::QOpenGLViewer::tr("Selects", "SELECT click action");
  case CGAL::qglviewer::RAP_FROM_PIXEL:
    return CGAL::QOpenGLViewer::tr("Sets pivot point", "RAP_FROM_PIXEL click action");
  case CGAL::qglviewer::RAP_IS_CENTER:
    return CGAL::QOpenGLViewer::tr("Resets pivot point", "RAP_IS_CENTER click action");
  case CGAL::qglviewer::CENTER_FRAME:
    return CGAL::QOpenGLViewer::tr("Centers manipulated frame",
                         "CENTER_FRAME click action");
  case CGAL::qglviewer::CENTER_SCENE:
    return CGAL::QOpenGLViewer::tr("Centers scene", "CENTER_SCENE click action");
  case CGAL::qglviewer::SHOW_ENTIRE_SCENE:
    return CGAL::QOpenGLViewer::tr("Shows entire scene",
                         "SHOW_ENTIRE_SCENE click action");
  case CGAL::qglviewer::ALIGN_FRAME:
    return CGAL::QOpenGLViewer::tr("Aligns manipulated frame",
                         "ALIGN_FRAME click action");
  case CGAL::qglviewer::ALIGN_CAMERA:
    return CGAL::QOpenGLViewer::tr("Aligns camera", "ALIGN_CAMERA click action");
  }
  return QString::null;
}
...
CGAL_INLINE_FUNCTION
QString CGAL::QOpenGLViewer::formatClickActionPrivate(ClickBindingPrivate cbp) {
...
CGAL_INLINE_FUNCTION
bool CGAL::QOpenGLViewer::isValidShortcutKey(int key) {
 ...
 */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setMouseBindingDescription(::Qt::KeyboardModifiers modifiers,
...
bindings. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setMouseBindingDescription(
...
CGAL_INLINE_FUNCTION
QString CGAL::QOpenGLViewer::mouseString() const {
  QString text(
...
details. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setKeyDescription(unsigned int key, QString description) {
  if (description.isEmpty())
...
CGAL_INLINE_FUNCTION
QString CGAL::QOpenGLViewer::cameraPathKeysString() const {
...
setKeyDescription() as well as the \e standard CGAL::QOpenGLViewer::KeyboardAction
...
CGAL_INLINE_FUNCTION
QString CGAL::QOpenGLViewer::keyboardString() const {
  QString text(
      "<center><table border=\"1\" cellspacing=\"0\" cellpadding=\"4\">\n");
  text += QString("<tr bgcolor=\"#aaaacc\"><th align=\"center\">%1</th><th "
                  "align=\"center\">%2</th></tr>\n")
              .arg(CGAL::QOpenGLViewer::tr("Key(s)",
                                 "Keys column header in help window mouse tab"))
              .arg(CGAL::QOpenGLViewer::tr(
                  "Description",
                  "Description column header in help window mouse tab"));
  ...
  if (!keyDescription.isEmpty()) {
    ...
    text += QString("<tr bgcolor=\"#aaaacc\"><td colspan=2>%1</td></tr>\n")
                .arg(CGAL::QOpenGLViewer::tr("Standard viewer keys",
  ...
  if (!cpks.isNull()) {
    ...
    text += CGAL::QOpenGLViewer::tr("Camera paths are controlled using the %1 keys "
                          "(noted <i>Fx</i> below):",
    ...
    text += tableLine(
        keyString(playPathKeyboardModifiers()) + "<i>" +
            CGAL::QOpenGLViewer::tr("Fx", "Generic function key (F1..F12)") + "</i>",
        CGAL::QOpenGLViewer::tr("Plays path (or resets saved position)"));
    text += tableLine(
        keyString(addKeyFrameKeyboardModifiers()) + "<i>" +
            CGAL::QOpenGLViewer::tr("Fx", "Generic function key (F1..F12)") + "</i>",
        CGAL::QOpenGLViewer::tr("Adds a key frame to path (or defines a position)"));
    text += tableLine(
        keyString(addKeyFrameKeyboardModifiers()) + "<i>" +
            CGAL::QOpenGLViewer::tr("Fx", "Generic function key (F1..F12)") + "</i>+<i>" +
            CGAL::QOpenGLViewer::tr("Fx", "Generic function key (F1..F12)") + "</i>",
        CGAL::QOpenGLViewer::tr("Deletes path (or saved position)"));
  }
  text += "</table></center>";
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::aboutQOpenGLViewer() {
  help();
  helpWidget()->setCurrentIndex(3);
}

/*! Opens a modal help window that includes four tabs, respectively filled with
helpString(), keyboardString(), mouseString() and about libCGAL::QOpenGLViewer.

Rich html-like text can be used (see the QStyleSheet documentation). This method
is called when the user presses the CGAL::QOpenGLViewer::HELP key (default is 'H').
...
Viewer::keyPressEvent(QKeyEvent *e)
{
  ...
  CGAL::QOpenGLViewer::keyPressEvent(e);
}
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::keyPressEvent(QKeyEvent *e) {
  if (e->key() == 0) {
    e->ignore();
    return;
  }
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::keyReleaseEvent(QKeyEvent *e) {
  if (isValidShortcutKey(e->key()))
    currentlyPressedKey_ = ::Qt::Key(0);
}

CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::handleKeyboardAction(qglviewer::KeyboardAction id) {
  switch (id) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::resizeGL(int width, int height) {
...
/*! Defines the shortcut() that triggers a given CGAL::QOpenGLViewer::KeyboardAction.
...
Only one shortcut can be assigned to a given CGAL::QOpenGLViewer::KeyboardAction (new
bindings replace previous ones). If several KeyboardAction are binded to the
same shortcut, only one of them is active. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setShortcut(qglviewer::KeyboardAction action, unsigned int key) {
  keyboardBinding_[action] = key;
}

/*! Returns the keyboard shortcut associated to a given
CGAL::QOpenGLViewer::KeyboardAction.
...
CGAL_INLINE_FUNCTION
unsigned int CGAL::QOpenGLViewer::shortcut(qglviewer::KeyboardAction action) const {
...
CGAL_INLINE_FUNCTION
::Qt::Key CGAL::QOpenGLViewer::pathKey(unsigned int index) const {
...
\endcode */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setPathKey(int key, unsigned int index) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setPlayPathKeyboardModifiers(::Qt::KeyboardModifiers modifiers) {
  playPathKeyboardModifiers_ = modifiers;
}

/*! Sets the addKeyFrameKeyboardModifiers() value. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setAddKeyFrameKeyboardModifiers(
    ::Qt::KeyboardModifiers modifiers) {
...
CGAL_INLINE_FUNCTION
::Qt::KeyboardModifiers CGAL::QOpenGLViewer::addKeyFrameKeyboardModifiers() const {
...
CGAL_INLINE_FUNCTION
::Qt::KeyboardModifiers CGAL::QOpenGLViewer::playPathKeyboardModifiers() const {
...
/*! Defines a MouseAction binding.
  ...
  action). */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setMouseBinding(::Qt::KeyboardModifiers modifiers,
...
(CGAL::QOpenGLViewer::CAMERA or CGAL::QOpenGLViewer::FRAME).
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setMouseBinding(::Qt::Key key, ::Qt::KeyboardModifiers modifiers,
                                ::Qt::MouseButton button, qglviewer::MouseHandler handler,
                                qglviewer::MouseAction action, bool withConstraint) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setWheelBinding(::Qt::KeyboardModifiers modifiers,
...
In the current implementation only CGAL::QOpenGLViewer::ZOOM can be associated with
CGAL::QOpenGLViewer::FRAME, while CGAL::QOpenGLViewer::CAMERA can receive CGAL::QOpenGLViewer::ZOOM and
CGAL::QOpenGLViewer::MOVE_FORWARD.

The difference between CGAL::QOpenGLViewer::ZOOM and CGAL::QOpenGLViewer::MOVE_FORWARD is that
CGAL::QOpenGLViewer::ZOOM speed depends on the distance to the object, while
CGAL::QOpenGLViewer::MOVE_FORWARD moves at a constant speed defined by
CGAL::qglviewer::Camera::flySpeed(). */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setWheelBinding(::Qt::Key key, ::Qt::KeyboardModifiers modifiers,
                                qglviewer::MouseHandler handler, qglviewer::MouseAction action,
                                bool withConstraint) {
...
*/
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::clearMouseBindings() {
  mouseBinding_.clear();
  clickBinding_.clear();
  wheelBinding_.clear();
}
...
*/
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::clearShortcuts() {
...
Returns CGAL::QOpenGLViewer::NO_MOUSE_ACTION if no action is associated with this
...
if (ma != CGAL::QOpenGLViewer::NO_MOUSE_ACTION) ...
\endcode

Use mouseHandler() to know which object (CGAL::QOpenGLViewer::CAMERA or CGAL::QOpenGLViewer::FRAME)
will execute this action. */
CGAL_INLINE_FUNCTION
qglviewer::MouseAction CGAL::QOpenGLViewer::mouseAction(::Qt::Key key,
                                              ::Qt::KeyboardModifiers modifiers,
...
if (mh == CGAL::QOpenGLViewer::CAMERA) ...
\endcode

Use mouseAction() to know which action (see the MouseAction enum) will be
performed on this handler. */
CGAL_INLINE_FUNCTION
int CGAL::QOpenGLViewer::mouseHandler(::Qt::Key key, ::Qt::KeyboardModifiers modifiers,
                            ::Qt::MouseButton button) const {
  MouseBindingPrivate mbp(modifiers, button, key);
  if (mouseBinding_.contains(mbp))
...
*/
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::getWheelActionBinding(qglviewer::MouseHandler handler, qglviewer::MouseAction action,
...
*/
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::getMouseActionBinding(qglviewer::MouseHandler handler, qglviewer::MouseAction action,
                                      bool withConstraint, ::Qt::Key &key,
                                      ::Qt::KeyboardModifiers &modifiers,
                                      ::Qt::MouseButton &button) const {
  for (QMap<MouseBindingPrivate, MouseActionPrivate>::ConstIterator
...
CGAL_INLINE_FUNCTION
CGAL::QOpenGLViewer::wheelAction(::Qt::Key key, ::Qt::KeyboardModifiers modifiers) const {
  WheelBindingPrivate wbp(modifiers, key);
  if (wheelBinding_.contains(wbp))
...
*/
CGAL_INLINE_FUNCTION
int CGAL::QOpenGLViewer::wheelHandler(::Qt::Key key,
                            ::Qt::KeyboardModifiers modifiers) const {
  WheelBindingPrivate wbp(modifiers, key);
  if (wheelBinding_.contains(wbp))
...
CGAL::QOpenGLViewer::clickAction(::Qt::Key key, ::Qt::KeyboardModifiers modifiers,
...
*/
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::getClickActionBinding(qglviewer::ClickAction action, ::Qt::Key &key,
                                      ::Qt::KeyboardModifiers &modifiers,
                                      ::Qt::MouseButton &button,
                                      bool &doubleClick,
                                      ::Qt::MouseButtons &buttonsBefore) const {
...
CGAL_INLINE_FUNCTION
bool CGAL::QOpenGLViewer::cameraIsInRotateMode() const {
...
\arg In rotate mode: CGAL::QOpenGLViewer::ROTATE, CGAL::QOpenGLViewer::ZOOM, CGAL::QOpenGLViewer::TRANSLATE.
\arg In fly mode: CGAL::QOpenGLViewer::MOVE_FORWARD, CGAL::QOpenGLViewer::LOOK_AROUND,
CGAL::QOpenGLViewer::MOVE_BACKWARD.

The current mode is determined by checking if a mouse button is binded to
CGAL::QOpenGLViewer::ROTATE for the CGAL::QOpenGLViewer::CAMERA. The state key that was previously
used to move the camera is preserved. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::toggleCameraMode() {
  ::Qt::Key key;
  ::Qt::KeyboardModifiers modifiers;
  ::Qt::MouseButton button;
  getMouseActionBinding(qglviewer::CAMERA, qglviewer::ROTATE, true /*constraint*/, key, modifiers,
...
a second viewer. */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setManipulatedFrame(qglviewer::ManipulatedFrame *frame) {
  if (manipulatedFrame()) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::drawVisualHints() {
  // G r i d
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setVisualHintsMask(int mask, int delay) {
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::resetVisualHints() { visualHint_ = 0; }
#endif
...
*/
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::drawArrow(double r,double R, int prec, CGAL::qglviewer::Vec from,
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::drawAxis(qreal length) {
  std::vector<float> data;
  data.resize(0);
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::drawGrid(qreal size, int nbSubdivisions) {
...
/*! saveStateToFile() is called on all the CGAL::QOpenGLViewers using the QOpenGLViewerPool().
 */
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::saveStateToFileForAllViewers() {
  Q_FOREACH (CGAL::QOpenGLViewer *viewer, CGAL::QOpenGLViewer::QOpenGLViewerPool()) {
    if (viewer)
...
QOpenGLViewer::QOpenGLViewerIndex()) for extra viewers. Each viewer will then read back
...
CGAL_INLINE_FUNCTION
QString CGAL::QOpenGLViewer::stateFileName() const {
  QString name = stateFileName_;

  if (!name.isEmpty() && QOpenGLViewer::QOpenGLViewerIndex(this) > 0) {
    QFileInfo fi(name);
    if (fi.suffix().isEmpty())
      name += QString::number(QOpenGLViewer::QOpenGLViewerIndex(this));
    else
      name = fi.absolutePath() + '/' + fi.completeBaseName() +
             QString::number(QOpenGLViewer::QOpenGLViewerIndex(this)) + "." +
             fi.suffix();
  }
...
/*! Saves in stateFileName() an XML representation of the CGAL::QOpenGLViewer state,
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::saveStateToFile() {
  ...
  if (f.open(QIODevice::WriteOnly)) {
    QTextStream out(&f);
    QDomDocument doc("QOpenGLVIEWER");
    doc.appendChild(domElement("CGAL::QOpenGLViewer", doc));
    doc.save(out, 2);
    f.flush();
    f.close();
  } else
...
/*! Restores the CGAL::QOpenGLViewer state from the stateFileName() file using
initFromDOMElement().
...
\endcode */
CGAL_INLINE_FUNCTION
bool CGAL::QOpenGLViewer::restoreStateFromFile() {
  QString name = stateFileName();
...
/*! Returns an XML \c QDomElement that represents the CGAL::QOpenGLViewer.

Used by saveStateToFile(). restoreStateFromFile() uses initFromDOMElement() to
restore the CGAL::QOpenGLViewer state from the resulting \c QDomElement.
...
CGAL_INLINE_FUNCTION
QDomElement res = CGAL::QOpenGLViewer::domElement(name, document);
res.appendChild(de);
return res;
}
\endcode
...
CGAL_INLINE_FUNCTION
QDomElement CGAL::QOpenGLViewer::domElement(const QString &name,
...
/*! Restores the CGAL::QOpenGLViewer state from a \c QDomElement created by domElement().

Used by restoreStateFromFile() to restore the CGAL::QOpenGLViewer state from a file.

Overload this method to retrieve custom attributes from the CGAL::QOpenGLViewer state
...
CGAL_INLINE_FUNCTION
CGAL::QOpenGLViewer::initFromDOMElement(element);
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::initFromDOMElement(const QDomElement &element) {
  QDomElement child = element.firstChild().toElement();
...
CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::copyBufferToTexture(GLint , GLenum ) {
}
...
CGAL_INLINE_FUNCTION
GLuint CGAL::QOpenGLViewer::bufferTextureId() const {
    return 0;
}

CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setOffset(CGAL::qglviewer::Vec offset)
{ 
  this->_offset = offset; 
}

CGAL_INLINE_FUNCTION
CGAL::qglviewer::Vec CGAL::QOpenGLViewer::offset()const 
{ 
  return _offset; 
}

CGAL_INLINE_FUNCTION
qreal CGAL::QOpenGLViewer::sceneRadius() const { return camera()->sceneRadius(); }

CGAL_INLINE_FUNCTION
CGAL::qglviewer::Vec CGAL::QOpenGLViewer::sceneCenter() const { return camera()->sceneCenter(); }

CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setSceneRadius(qreal radius) {
  camera()->setSceneRadius(radius);
}

CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setSceneCenter(const CGAL::qglviewer::Vec &center) {
  camera()->setSceneCenter(center);
}

CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::setSceneBoundingBox(const CGAL::qglviewer::Vec &min,
                         const CGAL::qglviewer::Vec &max) {
  camera()->setSceneBoundingBox(min + offset(), max + offset());
}

CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::showEntireScene() {
  camera()->showEntireScene();
  update();
}
...
CGAL_INLINE_FUNCTION
QImage* CGAL::QOpenGLViewer::takeSnapshot( CGAL::qglviewer::SnapShotBackground  background_color, QSize finalSize, double oversampling, bool expand)
{
  makeCurrent();
...
CGAL_INLINE_FUNCTION
QOpenGLFramebufferObject* CGAL::QOpenGLViewer::getStoredFrameBuffer()
{
  return stored_fbo;
}

CGAL_INLINE_FUNCTION
void CGAL::QOpenGLViewer::saveSnapshot()
{
  qreal aspectRatio = width() / static_cast<qreal>(height());
