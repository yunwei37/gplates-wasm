...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/mouseGrabber_impl.h $
...
that it is no longer tested with checkIfGrabsMouse() by the CGAL::QOpenGLViewer, and hence
...
/*! Clears the MouseGrabberPool().
 ...
 CGAL::QOpenGLViewer::setMouseTracking(false) instead if you want to disable mouse
 grabbing.
