...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/frame_impl.h $
// $Id: frame_impl.h 1df3c3e %aI Laurent Rineau
...
connected to a CGAL::QOpenGLViewer::update() slot. See also setTranslationAndRotation()
...
Only one modified() signal is emitted, which is convenient if this signal is
connected to a CGAL::QOpenGLViewer::update() slot. See also setPositionAndOrientation()
