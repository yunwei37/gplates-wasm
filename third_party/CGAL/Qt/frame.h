...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/frame.h $
// $Id: frame.h 1969ee9 %aI Andreas Fabri
// SPDX-License-Identifier: GPL-3.0
#ifndef QOpenGLVIEWER_FRAME_H
#define QOpenGLVIEWER_FRAME_H
...
/*! \brief The Frame class represents a coordinate system, defined by a position
  and an orientation. \class Frame frame.h CGAL::QOpenGLViewer/frame.h
  ...
  CGAL::QOpenGLViewer::draw() method, see the <a href="../introduction.html">introduction
  page</a>).
...
Q_SIGNALS:
  ...
  \endcode
  Use the CGAL::QOpenGLViewer::QOpenGLViewerPool() to connect the signal to all the viewers.
  ...
  CGAL::QOpenGLViewer::draw() method as it would result in an infinite loop. However,
  CGAL::QOpenGLViewer::draw() should not modify the scene.
