...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/manipulatedFrame_impl.h $
...
/*! Returns \c true when the ManipulatedFrame is being manipulated with the
  ...
  When Camera::frame() of the CGAL::QOpenGLViewer::camera() isManipulated(),
  CGAL::QOpenGLViewer::fastDraw() is used in place of CGAL::QOpenGLViewer::draw() for scene
...
/* spin() and spinUpdate() differ since spin can be used by itself (for instance
   by CGAL::QOpenGLViewer::SCREEN_ROTATE) without a spun emission. Much nicer to use the
...
href="../mouse.html">CGAL::QOpenGLViewer mouse page</a> for details. */
CGAL_INLINE_FUNCTION
...
and the <a href="../mouse.html">CGAL::QOpenGLViewer mouse page</a> for details.
...
Using the wheel is equivalent to a ZOOM MouseAction. See
 CGAL::QOpenGLViewer::setWheelBinding(), setWheelSensitivity(). */
CGAL_INLINE_FUNCTION
void ManipulatedFrame::wheelEvent(QWheelEvent *const event,
                                  Camera *const camera) {
  //#CONNECTION# CGAL::QOpenGLViewer::setWheelBinding
  if (action_ == ZOOM) {
