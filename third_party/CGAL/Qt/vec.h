...
*****************************************************************************/
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/GraphicsView/include/CGAL/Qt/vec.h $
// $Id: vec.h f627339 %aI Andreas Fabri
// SPDX-License-Identifier: GPL-3.0

#ifndef QOpenGLVIEWER_VEC_H
#define QOpenGLVIEWER_VEC_H
...
/*! \brief The Vec class represents 3D positions and 3D vectors.
  \class Vec vec.h CGAL::QOpenGLViewer/vec.h
...
#define QOpenGLVIEWER_UNION_NOT_SUPPORTED
#endif

public:
/*! The internal data representation is public. One can use v.x, v.y, v.z. See
 * also operator[](). */
#if defined(DOXYGEN) || defined(QOpenGLVIEWER_UNION_NOT_SUPPORTED)
  qreal x, y, z;
#else
  union {
    struct {
...
#ifdef QOpenGLVIEWER_UNION_NOT_SUPPORTED
    return (&x)[i];
#else
    return v_[i];
#endif
