...
struct data_extractor_implementation< member_at::left, Relation > :
    public std::__unary_function<Relation,BOOST_DEDUCED_TYPENAME Relation::left_value_type>
{
...
struct data_extractor_implementation< member_at::right, Relation > :
    public std::__unary_function<Relation,BOOST_DEDUCED_TYPENAME Relation::right_value_type>
{
