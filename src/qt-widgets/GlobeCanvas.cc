/* $Id: GlobeCanvas.cc 20041 2021-07-29 15:03:35Z jcannon $ */
 ...
 *
 * Most recent change:
 *   $Date: 2021-07-29 08:03:35 -0700 (Thu, 29 Jul 2021) $
 * 
...
GPlatesQtWidgets::GlobeCanvas::initializeGL() 
{
	...
	d_gl_off_screen_context =
			GPlatesOpenGL::GLOffScreenContext::create(
					GPlatesOpenGL::GLOffScreenContext::QOpenGLWidgetContext(this, d_gl_context));
