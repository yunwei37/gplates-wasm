/* $Id: GLFilledPolygonsMapView.cc 18506 2018-01-18 02:21:47Z jcannon $ */

/**
 * \file 
 * $Revision: 18506 $
 * $Date: 2018-01-17 18:21:47 -0800 (Wed, 17 Jan 2018) $
 * 
		...
		const filled_drawables_type &filled_drawables)
{
    ...
    qDebug("We need a stencil buffer so return early if there's not one.");
