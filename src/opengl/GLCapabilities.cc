/* $Id: GLCapabilities.cc 18649 2018-07-18 10:10:01Z jcannon $ */

/**
 * \file 
 * $Revision: 18649 $
 * $Date: 2018-07-18 03:10:01 -0700 (Wed, 18 Jul 2018) $
 * 
...
{
    qDebug("In case old 'glew.h' header (GL_ARB_viewport_array is fairly recent)");
...
GPlatesOpenGL::GLCapabilities::initialise_framebuffer()
{
    ...
    qDebug("GPlatesOpenGL::GLCapabilities::initialise_framebuffer()");
...
{
    qDebug("GPlatesOpenGL::GLCapabilities::initialise_shader()");
...
GPlatesOpenGL::GLCapabilities::initialise_texture()
{
    ...
    qDebug("GPlatesOpenGL::GLCapabilities::initialise_texture()");
...
{
    qDebug("GPlatesOpenGL::GLCapabilities::initialise_vertex()");
...
{
    qDebug("GPlatesOpenGL::GLCapabilities::initialise_buffer()");
