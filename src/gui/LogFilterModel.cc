/* $Id: LogFilterModel.cc 12123 2011-08-17 07:23:49Z jclark $ */
 ...
 *
 * $Revision: 12123 $
 * $Date: 2011-08-17 00:23:49 -0700 (Wed, 17 Aug 2011) $ 
 * 
		...
		bool show_critical_messages)
{
	...
	// QRegularExpression("text", Qt::CaseInsensitive, QRegularExpression::FixedString) were called.
